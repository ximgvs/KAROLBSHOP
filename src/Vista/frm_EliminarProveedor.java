...
package Vista;
import Controlador.C_EliminarProveedor;
...
public class frm_EliminarProveedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnNuevaVenta3.setText("REGISTRAR PROOV");
        ...
        btnClientes11.setText("VER PROVEEDOR");
        ...
        jPanel8.add(txtBuscarProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 160, 600, 60));

        jLabel16.setFont(new java.awt.Font("SimSun-ExtB", 1, 18)); // NOI18N
        jLabel16.setText("BUSCAR ID DEL PROVEEDOR A ELIMINAR:");
        jPanel8.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 100, 360, 40));
        ...
        jPanel8.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 260, 150, 60));
        ...
        jPanel8.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 260, 170, 60));
        ...
        jPanel8.add(btnLimpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 260, 140, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_EliminarProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            new frm_EliminarProveedor().setVisible(true);
            M_EliminarProveedor modelo = new M_EliminarProveedor();
            frm_EliminarProveedor vista = new frm_EliminarProveedor();
            new C_EliminarProveedor(modelo, vista);
